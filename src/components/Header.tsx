      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <Link to="/" className="text-white hover:text-yellow-400 transition-colors duration-200 font-semibold relative group">
              صفحه اصلی
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t border-gray-700 bg-gray-900 backdrop-blur-sm rounded-b-xl shadow-lg">
            <nav className="flex flex-col gap-4 mt-4">
              <Link to="/" className="text-white hover:text-yellow-400 font-medium py-2 hover:bg-gray-800 rounded-lg px-2 transition-all duration-200">
                صفحه اصلی
              </Link>
